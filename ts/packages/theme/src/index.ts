...
/**
 * Browser-side projection of the generated Appearance settings state.
 *
 * The backend remains the theme authority: clients only accept sanitized
 * --agora-* token values returned by the generated Appearance contract. The
 * evidence tokens are deliberately excluded because they are capture markers,
 * not user-configurable presentation.
 */
export function liveThemeClientScript(): string {
  return String.raw`(()=>{
