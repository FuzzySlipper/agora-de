...
const (
	...
	TokenPanelPaddingY                        = "--agora-panel-padding-y"
...
func DefaultTokenDefinitions() []TokenDefinition {
	return []TokenDefinition{
		{Name: TokenBackground, Value: "#0b2a39", Role: RolePresentation, Description: "Canvas background for shell fallback and chrome surfaces."},
		{Name: TokenForeground, Value: "#d4e6ec", Role: RolePresentation, Description: "Primary text color for shell fallback and chrome surfaces."},
		{Name: TokenSurface, Value: "#143c4c", Role: RolePresentation, Description: "Panel and plain section background."},
		{Name: TokenSurfaceRaised, Value: "#1c4a5a", Role: RolePresentation, Description: "Raised controls, list items, and code blocks."},
		{Name: TokenSurfaceStrong, Value: "#04202e", Role: RolePresentation, Description: "High-contrast badges and icon chips."},
		{Name: TokenTextMuted, Value: "#7090a0", Role: RolePresentation, Description: "Secondary labels and muted details."},
		{Name: TokenAccent, Value: "#5ec4a8", Role: RolePresentation, Description: "Interactive accent for normal shell presentation."},
		{Name: TokenWarning, Value: "#ffbf3e", Role: RoleState, Description: "Warning border and status color."},
		{Name: TokenBorder, Value: "#2e5a6a", Role: RolePresentation, Description: "Default control border."},
		{Name: TokenBorderSubtle, Value: "#1c4454", Role: RolePresentation, Description: "Subtle dividers and inactive item borders."},
		...
		{Name: TokenPanelHeight, Value: "54px", Role: RoleLayout, Description: "Installed panel height."},
		{Name: TokenPanelGap, Value: "14px", Role: RoleLayout, Description: "Panel item gap."},
		{Name: TokenPanelPaddingY, Value: "6px", Role: RoleLayout, Description: "Vertical panel padding."},
